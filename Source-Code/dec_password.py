...
# Form implementation generated from reading ui file 'decPassword.ui'
#
...
class Ui_passwordWindow(object):
    ...
    def retranslateUi(self, passwordWindow):
        ...
        self.label.setText(_translate("passwordWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; font-style:italic;\">Enter your Password to Decrypt the File!</span></p></body></html>", None))
